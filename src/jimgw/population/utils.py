...
def extract_all_data_from_npz_files(data_dir, num_samples=50, random_seed=42):
    """
    Extracts all column data from the given .npz files.
    ...
    Returns:
    - dict: Dictionary of stacked arrays for each column.
    """
    ...
    for npz_file in npz_files:
        ...
        with np.load(npz_file, allow_pickle=True) as data:
            ...
            for column_name, column_data in data_dict.items():
                extracted_data = column_data.reshape(-1,)
